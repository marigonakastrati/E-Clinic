 ...
 * @author F
 */
public class MouseAdapterAddPharmacistScreen extends MouseAdapter{
    private JFAdmin jfAdmin;

    public MouseAdapterAddPharmacistScreen(JFAdmin jfAdmin) {
    ...
    {
        jfAdmin.showAddPharmacistScreen();
    }
