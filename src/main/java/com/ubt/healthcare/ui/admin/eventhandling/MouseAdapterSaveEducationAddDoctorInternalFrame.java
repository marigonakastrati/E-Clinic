 ...
 * @author F
 */
public class MouseAdapterSaveEducationAddDoctorInternalFrame extends MouseAdapter{
    private JIFAddDoctor jidAddDoctor;

    public MouseAdapterSaveEducationAddDoctorInternalFrame(JIFAddDoctor jidAddDoctor) {
