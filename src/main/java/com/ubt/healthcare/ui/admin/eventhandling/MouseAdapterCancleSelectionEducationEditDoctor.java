 ...
 * @author F
 */
public class MouseAdapterCancleSelectionEducationEditDoctor extends MouseAdapter{
    private JIFEditDoctor jidEditDoctor;

    public MouseAdapterCancleSelectionEducationEditDoctor(JIFEditDoctor jidEditDoctor) {
