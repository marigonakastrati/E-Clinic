...
import com.ubt.healthcare.business.PharmacistService;
...
import com.ubt.healthcare.ui.admin.model.PharmacistTableModelViewPharmacist;
 ...
 * @author F
 */
public class JIFPharmacist extends javax.swing.JInternalFrame {

    private List<Pharmacist> pharmacistList;
    private PharmacistService pharmacistService;
    private PharmacistTableModelViewPharmacist pharmacistTableModelViewPharmacist;
    ...
    /**
     * Creates new form JIFPharmacistF
     */
    public JIFPharmacist() {
        initComponents();
        ...
        fillComboBoxGender();
        bindThePharmacistSearchTableModel();
    ...
    private void initComponents() {
        ...
        jtpPharmacist = new javax.swing.JTabbedPane();
        ...
        jspPharmacistTable = new javax.swing.JScrollPane();
        jtPharmacistListTable = new javax.swing.JTable();
        ...
        jbSearchPharmacist = new javax.swing.JButton();
        jbSavePharmacist = new javax.swing.JButton();
        ...
        jtpPharmacist.addTab("Personal Information", jspPersonalInformation);

        jtPharmacistListTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jspPharmacistTable.setViewportView(jtPharmacistListTable);
        ...
        jbSearchPharmacist.setText("Search");

        jbSavePharmacist.setText("Save");
        jbSavePharmacist.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbSavePharmacistActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtpPharmacist, javax.swing.GroupLayout.DEFAULT_SIZE, 889, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jspPharmacistTable))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(203, 203, 203)
                                .addComponent(jbSavePharmacist, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(96, 96, 96)
                                .addComponent(jbCancel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(86, 86, 86)
                                .addComponent(jbSearchPharmacist, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jbSavePharmacist)
                    .addComponent(jbCancel)
                    .addComponent(jbSearchPharmacist))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jlFirstNameSearch)
                    .addComponent(jlLastNameSearch)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jspPharmacistTable, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtpPharmacist)
                .addContainerGap())
        );
    ...
    private void jbSavePharmacistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSavePharmacistActionPerformed

    }//GEN-LAST:event_jbSavePharmacistActionPerformed
    ...
    private javax.swing.JButton jbSavePharmacist;
    private javax.swing.JButton jbSearchPharmacist;
    ...
    private javax.swing.JScrollPane jspPharmacistTable;
    private javax.swing.JTable jtPharmacistListTable;
    ...
    private javax.swing.JTabbedPane jtpPharmacist;
    // End of variables declaration//GEN-END:variables

    public void addSavePharmacistInternalFrameMouseAdapter(MouseAdapter e) {
        jbSavePharmacist.addMouseListener(e);
    }

// Mouse Event listener for Search button
    public void addSearchPharmacistPanelMouseAdapter(MouseAdapter e) {
        jbSearchPharmacist.addMouseListener(e);
    }

// load Pharmacist Table 
    public void loadPharmacistListTable(String name, String surname, String city) {
        try {
            pharmacistList = pharmacistService.findPharmacistsByParameters(name, surname, city);
            pharmacistTableModelViewPharmacist = new PharmacistTableModelViewPharmacist(pharmacistList);
            jtPharmacistListTable.setModel(pharmacistTableModelViewPharmacist);
            pharmacistTableModelViewPharmacist.fireTableDataChanged();
        } catch (Exception ex) {
    ...
    // method which searches for Pharmacist
    public void searchPharmacistInternalPane() {
        String nameOfPharmacist = jtfFirstNameSearch.getText();
        String surnameOfPharmacist = jtfLastNameSearch.getText();
        String cityOfPharmacist = jcbCitySearch.getSelectedIndex() < 0 ? "" : jcbCitySearch.getSelectedItem().toString();

        if (nameOfPharmacist.trim().length() == 0 && surnameOfPharmacist.trim().length() == 0 && cityOfPharmacist.trim().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Please fill the fields to find the Pharmacist you are looking for");
        } else {

            loadPharmacistListTable(nameOfPharmacist, surnameOfPharmacist, cityOfPharmacist);
...
// pharmacist view listener

    public void pharmacistTableRowSelectionListener() {
        final ListSelectionModel selectedModel = jtPharmacistListTable.getSelectionModel();
        selectedModel.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (selectedRow > -1) {
                    ...
                    Person pe = pharmacistTableModelViewPharmacist.getPharmacist(selectedRow).getPersonId();
    ...
    private void bindThePharmacistSearchTableModel() {
        pharmacistTableModelViewPharmacist = new PharmacistTableModelViewPharmacist(new ArrayList<>());
        pharmacistTableModelViewPharmacist.add(new ArrayList<>());
        jtPharmacistListTable.setModel(pharmacistTableModelViewPharmacist);
        pharmacistTableModelViewPharmacist.fireTableDataChanged();
        pharmacistTableRowSelectionListener();
    }
...
// person might have just one contact details, soo clear the reamaining details of past selected persson
    ...
    public void savePharmacistInternalFrameAddPharmacist() {

        int row = jtPharmacistListTable.getSelectedRow();
        //jifAddPharmacist.getT
        ...
        //save pharmacist on database using pharmacist service
            ...
            if (row == -1) {
                ...
                if (!("Valid".equals(inputValidation.validatePassword(password)))) {
                    ...
                    try {
                        ...
                        pharmacist.getPersonId().setPersonId(Integer.parseInt(personId));
                        pharmacist.getPersonId().setFirstName(firstName);
                        pharmacist.getPersonId().setMiddleName(middleName);
                        pharmacist.getPersonId().setLastName(lastName);
                        pharmacist.setPassCode(passwordHashing.encodehashPassword(password));
                        pharmacist.getPersonId().setDateOfBirth(dateOfBirth);
                        ...
                        //set the combobox values to pharmacist
                        pharmacist.getPersonId().setGenderId(findTheGender);
                        pharmacist.getPersonId().setMartialStatusId(findTheMartialStatus);
                        pharmacist.getPersonId().setAddressId(theAddress);
                        pharmacist.getPersonId().setBirthCityId(birthPlaceObject);
                        pharmacist.getPersonId().setReigionId(findTheReligion);
                        ...
                        String personMsg = personService.checkIfUserExists(pharmacist.getPersonId());
                        ...
                        if ("Save".equals(personMsg)) {
                            ...
                            if ("Save".equals(personMsg)) {
                                ...
                                String pharmacistSavedMsg = pharmacistService.persistPharmacist(pharmacist);
                                JOptionPane.showMessageDialog(null, pharmacistSavedMsg);// if pharmacist is not saved do not save other stuff.

                                // save the education details.
                                //persistEducation(); next version
                                // persist UserGroup
                                String userGroupMsg = userGroupService.checkIfUserGroupExists(pharmacist);
                                if ("Save".equals(userGroupMsg)) {
                                    UserGroup userGroup = new UserGroup();
                                    userGroup.setUserId(pharmacist.getPharmacistId());
                                    userGroup.setGroupId(loginGroupService.findTheLoginGroup("Pharmacist"));
                                ...
                                // clear the Fields 
                                //clearAddPharmacistFields();
                                // close the add new pharmacist 
                                //jifAddPharmacist.dispose();
                                //this.show();
                                // update the fields on jifPharmacist to see the newly added pharmacist
                                //updatePharmacistFields(pharmacist);
                ...
                try {
                    pharmacist = pharmacistTableModelViewPharmacist.getPharmacist(row);
                    //update the fields
                    ...
                    if ("Exist".equals(personMsg)) {
                        ...
                        if ("Exist".equals(personMsg)) {
                            // validate pharmacist input
                            pharmacistService.editPharmacist(pharmacist);
                            JOptionPane.showMessageDialog(null, "Pharmacist Edited");// if pharmacist is not saved do not save other stuff.

                            // save the education details.
                            //persistEducation(); next version
                            // save the conntact details...
                            //editContact(oldValue, newValue)
                            Collection<Contact> contactCollection = pharmacist.getPersonId().getContactCollection();
                            if (contactCollection != null && contactCollection.size() > 0) {
                                // person might have just one contact details, soo clear the reamaining details of past selected persson
                                for (Contact contact : contactCollection) {
                                    switch (contact.getType().trim()) {
