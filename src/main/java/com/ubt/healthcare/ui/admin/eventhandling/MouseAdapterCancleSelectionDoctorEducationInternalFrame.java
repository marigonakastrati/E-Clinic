 ...
 * @author F
 */
public class MouseAdapterCancleSelectionDoctorEducationInternalFrame extends MouseAdapter{
    private JIFAddDoctor jidAddDoctor;

    public MouseAdapterCancleSelectionDoctorEducationInternalFrame(JIFAddDoctor jidAddDoctor) {
