 ...
 * @author F
 */
public class MouseAdapterCloseAddNewDoctorInternalFrame extends MouseAdapter{
    private JIFDoctor jifDoctorScreen;

    public MouseAdapterCloseAddNewDoctorInternalFrame(JIFDoctor jifDoctorScreen) {
