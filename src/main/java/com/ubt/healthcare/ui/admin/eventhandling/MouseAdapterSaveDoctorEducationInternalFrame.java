 ...
 * @author F
 */
public class MouseAdapterSaveDoctorEducationInternalFrame extends MouseAdapter{
    private JIFAddDoctor jidAddDoctor;

    public MouseAdapterSaveDoctorEducationInternalFrame(JIFAddDoctor jidAddDoctor) {
