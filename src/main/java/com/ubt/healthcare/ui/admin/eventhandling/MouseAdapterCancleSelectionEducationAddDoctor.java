 ...
 * @author F
 */
public class MouseAdapterCancleSelectionEducationAddDoctor extends MouseAdapter{
    private JIFAddDoctor jidAddDoctor;

    public MouseAdapterCancleSelectionEducationAddDoctor(JIFAddDoctor jidAddDoctor) {
