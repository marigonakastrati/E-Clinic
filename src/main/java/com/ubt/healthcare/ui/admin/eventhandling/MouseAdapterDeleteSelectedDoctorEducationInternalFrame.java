 ...
 * @author F
 */
public class MouseAdapterDeleteSelectedDoctorEducationInternalFrame extends MouseAdapter{
    private JIFAddDoctor jidAddDoctor;

    public MouseAdapterDeleteSelectedDoctorEducationInternalFrame(JIFAddDoctor jidAddDoctor) {
