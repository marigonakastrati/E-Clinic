 ...
 * @author F
 */
public class PharmacistTableModelViewPharmacist extends AbstractTableModel {

    private final String[] columnNames = {"FirstName", "LastName", "City", "Phone Number"};

    private List<Pharmacist> data;

    public PharmacistTableModelViewPharmacist(List<Pharmacist> data) {
        this.data = data;
    }

    public PharmacistTableModelViewPharmacist() {
    }

    public void add(List<Pharmacist> data) {
        this.data = data;
    }
    ...
    public Pharmacist getPharmacist(int index){
        return data.get(index);
    }
    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        Pharmacist s = (Pharmacist)data.get(rowIndex);
        switch(columnIndex){
