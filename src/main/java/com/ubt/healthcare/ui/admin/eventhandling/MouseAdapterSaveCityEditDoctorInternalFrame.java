 ...
 * @author F
 */
public class MouseAdapterSaveCityEditDoctorInternalFrame extends MouseAdapter{
    private JIFEditDoctor jifEditDoctor;

    public MouseAdapterSaveCityEditDoctorInternalFrame(JIFEditDoctor jifEditDoctor) {
