 ...
 * @author Marigona
 */
public class MouseAdapterPharmacistScreen extends MouseAdapter{
    private JFAdminScreen jfAdminScreen;

    public MouseAdapterPharmacistScreen(JFAdminScreen jfAdminScreen) {
    ...
    {
        jfAdminScreen.showPharmacistScreen();
    }
