 ...
 * @author F
 */
public class MouseAdapterViewSearchDoctor extends MouseAdapter{
    private JFClinicManager jfHRManager;

    public MouseAdapterViewSearchDoctor(JFClinicManager jfHRManager) {
    ...
    {
        jfHRManager.showSearchDoctorScreen();
    }
